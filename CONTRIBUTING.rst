...
1. Update the README file with details of any changes to the workflows.
2. Increase the version numbers in any example files and the README to the new
   version that this Pull Request would represent. The versioning scheme we
   use is `SemVer`_.
3. Request project review on the PR and address any needed changes.
